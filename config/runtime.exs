...
#
#     PHX_SERVER=true bin/spend_log start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :spend_log, SpendLogWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :spend_log, SpendLog.Repo,
    # ssl: true,
    url: database_url,
  ...
  config :spend_log, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  config :spend_log, SpendLogWeb.Endpoint,
    ...
    cache_static_manifest_latest: PhoenixVite.cache_static_manifest_latest(:spend_log)
  ...
  #
  #     config :spend_log, SpendLog.Mailer,
